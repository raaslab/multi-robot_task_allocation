...
namespace gazebo
{
  class AnimatedBox : public ModelPlugin
  {
    ...
    {
      int first_time_step = 12;
      int second_time_step = 20;
      int third_time_step = 28;
      int fourth_time_step = 36;
      int fifth_time_step = 44;
      ...
      this->model = _parent;
        ...
        key = anim->CreateKeyFrame(first_time_step);
        key->Translation(ignition::math::Vector3d(0, 2, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(second_time_step);
        ...
        gazebo::common::PoseAnimationPtr anim_2(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_2", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_3(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_3", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_3;

        // set starting location of the box
        key_3 = anim_3->CreateKeyFrame(0);
        key_3->Translation(ignition::math::Vector3d(1, 7, 0));
        key_3->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_3 = anim_3->CreateKeyFrame(4);
        key_3->Translation(ignition::math::Vector3d(1, 7, 0));
        key_3->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_3 = anim_3->CreateKeyFrame(third_time_step);
        key_3->Translation(ignition::math::Vector3d(1, 7, 0));
        key_3->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_3 = anim_3->CreateKeyFrame(fourth_time_step);
        key_3->Translation(ignition::math::Vector3d(0, 3, 0));
        key_3->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_4(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_4", 1000.0, true));
        ...
        key_4 = anim_4->CreateKeyFrame(4);
        key_4->Translation(ignition::math::Vector3d(5, 5, 0));
        key_4->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_4 = anim_4->CreateKeyFrame(first_time_step);
        key_4->Translation(ignition::math::Vector3d(5, 5, 0));
        key_4->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_4 = anim_4->CreateKeyFrame(second_time_step);
        key_4->Translation(ignition::math::Vector3d(5, 1, 0));
        key_4->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_4 = anim_4->CreateKeyFrame(third_time_step);
        key_4->Translation(ignition::math::Vector3d(3, -1, 0));
        key_4->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_5(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_5", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_5;

        // set starting location of the box
        key_5 = anim_5->CreateKeyFrame(0);
        key_5->Translation(ignition::math::Vector3d(-3, 1, 0));
        key_5->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_5 = anim_5->CreateKeyFrame(4);
        key_5->Translation(ignition::math::Vector3d(-3, 1, 0));
        key_5->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_5 = anim_5->CreateKeyFrame(second_time_step);
        key_5->Translation(ignition::math::Vector3d(-3, 1, 0));
        key_5->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_5 = anim_5->CreateKeyFrame(third_time_step);
        key_5->Translation(ignition::math::Vector3d(-1, 3, 0));
        key_5->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_6(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_6", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_6;

        // set starting location of the box
        key_6 = anim_6->CreateKeyFrame(0);
        key_6->Translation(ignition::math::Vector3d(4, 2, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_7(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_7", 1000.0, true));
        ...
        key_7 = anim_7->CreateKeyFrame(4);
        key_7->Translation(ignition::math::Vector3d(6, 1, 0));
        key_7->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_7 = anim_7->CreateKeyFrame(third_time_step);
        key_7->Translation(ignition::math::Vector3d(6, 1, 0));
        key_7->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_7 = anim_7->CreateKeyFrame(fourth_time_step);
        key_7->Translation(ignition::math::Vector3d(3, 1, 0));
        key_7->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_8(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_8", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_9(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_9", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_10(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_10", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_10;

        // set starting location of the box
        key_10 = anim_10->CreateKeyFrame(0);
        key_10->Translation(ignition::math::Vector3d(1, -5, 0));
        key_10->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_10 = anim_10->CreateKeyFrame(4);
        key_10->Translation(ignition::math::Vector3d(1, -5, 0));
        key_10->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_10 = anim_10->CreateKeyFrame(second_time_step);
        key_10->Translation(ignition::math::Vector3d(1, -5, 0));
        key_10->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_10 = anim_10->CreateKeyFrame(third_time_step);
        key_10->Translation(ignition::math::Vector3d(0, -2, 0));
        key_10->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_11(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_11", 1000.0, true));
        ...
        key_11 = anim_11->CreateKeyFrame(4);
        key_11->Translation(ignition::math::Vector3d(0, 8, 0));
        key_11->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_11 = anim_11->CreateKeyFrame(first_time_step);
        key_11->Translation(ignition::math::Vector3d(0, 4, 0));
        key_11->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_11 = anim_11->CreateKeyFrame(second_time_step);
        key_11->Translation(ignition::math::Vector3d(0, 4, 0));
        key_11->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_11 = anim_11->CreateKeyFrame(third_time_step);
        key_11->Translation(ignition::math::Vector3d(0, 1, 0));
        key_11->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_12(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_12", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_13(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_13", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_14(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_14", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_15(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_15", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_15;

        // set starting location of the box
        key_15 = anim_15->CreateKeyFrame(0);
        key_15->Translation(ignition::math::Vector3d(-1, -1, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_16(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_16", 1000.0, true));
        ...
        key_16 = anim_16->CreateKeyFrame(4);
        key_16->Translation(ignition::math::Vector3d(-4, -4, 0));
        key_16->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_16 = anim_16->CreateKeyFrame(third_time_step);
        key_16->Translation(ignition::math::Vector3d(-4, -4, 0));
        key_16->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_16 = anim_16->CreateKeyFrame(fourth_time_step);
        key_16->Translation(ignition::math::Vector3d(-1, -3, 0));
        key_16->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_17(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_17", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_17;

        // set starting location of the box
        key_17 = anim_17->CreateKeyFrame(0);
        key_17->Translation(ignition::math::Vector3d(6, -2, 0));
        key_17->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_17 = anim_17->CreateKeyFrame(4);
        key_17->Translation(ignition::math::Vector3d(6, -2, 0));
        key_17->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_17 = anim_17->CreateKeyFrame(first_time_step);
        key_17->Translation(ignition::math::Vector3d(4, -4, 0));
        key_17->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_17 = anim_17->CreateKeyFrame(third_time_step);
        key_17->Translation(ignition::math::Vector3d(4, -4, 0));
        key_17->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_17 = anim_17->CreateKeyFrame(fourth_time_step);
        key_17->Translation(ignition::math::Vector3d(2, -2, 0));
        key_17->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_18(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_18", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_19(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_19", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_19;

        // set starting location of the box
        key_19 = anim_19->CreateKeyFrame(0);
        key_19->Translation(ignition::math::Vector3d(-5, -3, 0));
        key_19->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_19 = anim_19->CreateKeyFrame(4);
        key_19->Translation(ignition::math::Vector3d(-5, -3, 0));
        key_19->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_19 = anim_19->CreateKeyFrame(first_time_step);
        key_19->Translation(ignition::math::Vector3d(-3, 0, 0));
        key_19->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_20(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_20", 1000.0, true));
        ...
        key_20 = anim_20->CreateKeyFrame(4);
        key_20->Translation(ignition::math::Vector3d(-1, -3, 0));
        key_20->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_20 = anim_20->CreateKeyFrame(first_time_step);
        key_20->Translation(ignition::math::Vector3d(-1, -3, 0));
        key_20->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_20 = anim_20->CreateKeyFrame(second_time_step);
        key_20->Translation(ignition::math::Vector3d(-2, 0, 0));
        key_20->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_21(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_21", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_21;

        // set starting location of the box
        key_21 = anim_21->CreateKeyFrame(0);
        key_21->Translation(ignition::math::Vector3d(3, 6, 0));
        key_21->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_21 = anim_21->CreateKeyFrame(4);
        key_21->Translation(ignition::math::Vector3d(3, 6, 0));
        key_21->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_21 = anim_21->CreateKeyFrame(first_time_step);
        key_21->Translation(ignition::math::Vector3d(3, 6, 0));
        key_21->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_21 = anim_21->CreateKeyFrame(second_time_step);
        key_21->Translation(ignition::math::Vector3d(1, 4, 0));
        key_21->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_22(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_22", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_22;

        // set starting location of the box
        key_22 = anim_22->CreateKeyFrame(0);
        key_22->Translation(ignition::math::Vector3d(-4, 0, 0));
        key_22->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_22 = anim_22->CreateKeyFrame(4);
        key_22->Translation(ignition::math::Vector3d(-4, 0, 0));
        key_22->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_22 = anim_22->CreateKeyFrame(second_time_step);
        key_22->Translation(ignition::math::Vector3d(-4, 0, 0));
        key_22->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_22 = anim_22->CreateKeyFrame(third_time_step);
        key_22->Translation(ignition::math::Vector3d(-3, 3, 0));
        key_22->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_23(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_23", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_23;

        // set starting location of the box
        key_23 = anim_23->CreateKeyFrame(0);
        key_23->Translation(ignition::math::Vector3d(1, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_24(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_24", 1000.0, true));
        ...
        key_24 = anim_24->CreateKeyFrame(4);
        key_24->Translation(ignition::math::Vector3d(-1, 2, 0));
        key_24->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_24 = anim_24->CreateKeyFrame(first_time_step);
        key_24->Translation(ignition::math::Vector3d(2, 1, 0));
        key_24->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_25(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_25", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_25;

        // set starting location of the box
        key_25 = anim_25->CreateKeyFrame(0);
        key_25->Translation(ignition::math::Vector3d(-4, 5, 0));
        key_25->Rotation(ignition::math::Quaterniond(0, 0, 0));

        // key_25 = anim_25->CreateKeyFrame(10);
        // key_25->Translation(ignition::math::Vector3d(-7, 4, 0));
        // key_25->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_26(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_26", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_27(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_27", 1000.0, true));
        ...
        key_27 = anim_27->CreateKeyFrame(4);
        key_27->Translation(ignition::math::Vector3d(-5, 1, 0));
        key_27->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_27 = anim_27->CreateKeyFrame(third_time_step);
        key_27->Translation(ignition::math::Vector3d(-5, 1, 0));
        key_27->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_27 = anim_27->CreateKeyFrame(fourth_time_step);
        key_27->Translation(ignition::math::Vector3d(-2, 2, 0));
        key_27->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_28(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_28", 1000.0, true));
        ...
        key_28 = anim_28->CreateKeyFrame(4);
        key_28->Translation(ignition::math::Vector3d(-1, 6, 0));
        key_28->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_28 = anim_28->CreateKeyFrame(third_time_step);
        key_28->Translation(ignition::math::Vector3d(-1, 6, 0));
        key_28->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_28 = anim_28->CreateKeyFrame(fourth_time_step);
        key_28->Translation(ignition::math::Vector3d(-2, 3, 0));
        key_28->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        gazebo::common::PoseAnimationPtr anim_29(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_29", 1000.0, true));
        ...
        gazebo::common::PoseAnimationPtr anim_30(
              ...
              // make it last 10 seconds,
              // and set it on a repeat loop
              new gazebo::common::PoseAnimation("test_30", 1000.0, true));

        gazebo::common::PoseKeyFrame *key_30;

        // set starting location of the box
        key_30 = anim_30->CreateKeyFrame(0);
        key_30->Translation(ignition::math::Vector3d(8, 1, 0));
        key_30->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_30 = anim_30->CreateKeyFrame(4);
        key_30->Translation(ignition::math::Vector3d(8, 1, 0));
        key_30->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_30 = anim_30->CreateKeyFrame(second_time_step);
        key_30->Translation(ignition::math::Vector3d(8, 1, 0));
        key_30->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_30 = anim_30->CreateKeyFrame(third_time_step);
        key_30->Translation(ignition::math::Vector3d(6, 3, 0));
        key_30->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key_30 = anim_30->CreateKeyFrame(fourth_time_step);
        key_30->Translation(ignition::math::Vector3d(4, 1, 0));
        key_30->Rotation(ignition::math::Quaterniond(0, 0, 0));
